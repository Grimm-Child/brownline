...
class People(index.Indexed, ClusterableModel):
    ...
    rank = models.CharField("Group rank", max_length=254)
...
class StandardPage(Page):
    """
    A generic content page. Could be used for any type of page content that only needs a title,
    ...
    image = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        related_name='+',
        help_text='I hope you cropped your image before uploading it.'
    )
    body = StreamField(
...
class HomePage(Page):
    ...
    promo_text = RichTextField(
        null=True,
        blank=True,
        help_text='Write some promotional text'
    )
...
class GalleryPage(Page):
    ...
    image = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        related_name='+',
        help_text='Please make sure the image you are uploading has not been uploaded already.'
    )
    body = StreamField(
        BaseStreamBlock(), verbose_name="Page body", blank=True
    )
    collection = models.ForeignKey(
        ...
        blank=True,
        on_delete=models.SET_NULL,
        help_text='Select the image collection for this gallery to display.'
    )
